...
public class LessonTwo extends BaseLesson {
	...
	private boolean stage4() {
		makeLabelActor(130, 185, "Click the 'right' operation icon", 36, new Color(0xFFFF00FF));
	...
	private boolean stage5() {
		makeLabelActor(280, 280, "Let's release the brick at here", 36, new Color(0xFFFF00FF));
	...
	private boolean stage6() {
		makeLabelActor(330, 185, "Click the 'charge' operation icon again", 36, new Color(0xFFFF00FF));
	...
	private boolean stage9() {
		makeLabelActor(90, 370, "Now, you can call other columns directly in current column", 36, new Color(0xFFFF00FF));
	...
	private boolean stage10() {
		...
		makeLabelActor(100, 600, "'f0' ~ 'f3': used to call specified column", 36, new Color(0xFFFF00FF));
		
		return true;
	}
	
	private boolean stage11() {
		makeLabelActor(180, 360, "Here, Let's move Tray back right", 36, new Color(0xFFFF00FF));
	...
	private boolean stage12() {
		makeLabelActor(130, 270, "Click the 'left' operation icon", 36, new Color(0xFFFF00FF));
	...
	private boolean stage13() {
		makeLabelActor(280, 360, "OK, call 'f1' again to move other brick", 36, new Color(0xFFFF00FF));
	...
	private boolean stage14() {
		makeLabelActor(500, 270, "Click the 'f1' icon more one time", 36, new Color(0xFFFF00FF));
	...
	private boolean stage18() {
		...
		makeLabelActor(200, 250, "Congratulate, you have passed Lesson Two !", 45, new Color(0xFFFF00FF));		

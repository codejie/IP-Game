...
public class LessonThree extends BaseLesson {
	...
	private boolean stage0() {
		...
		makeLabelActor(70, 420, "Click here'", 36, new Color(0xFFFF00FF));
	...
	private boolean stage3() {
		makeLabelActor(180, 360, "Then, move them right together", 36, new Color(0xFFFF00FF));
	...
	private boolean stage4() {
		makeLabelActor(130, 270, "Click the 'right' icon", 36, new Color(0xFFFF00FF));
	...
	private boolean stage5() {
		...
		makeLabelActor(180, 390, "As what RIGHT shows, if the brick is Blue,", 36, new Color(0xFFFF00FF));
		makeLabelActor(200, 350, "we need move them right again", 36, new Color(0xFFFF00FF));
	...
	private boolean stage7() {
		...
		makeLabelActor(200, 510, "Now, if the brick is Green, we should release it,", 36, new Color(0xFFFF00FF));
		makeLabelActor(210, 470, "but if it is Blue, we have to move it right again before release it.", 36, new Color(0xFFFF00FF));
		makeLabelActor(270, 430, "So let's click here to check it is Green or Blue", 36, new Color(0xFFFF00FF));
	...
	private boolean stage8() {
		...
		makeLabelActor(180, 280, "Ok, click here to indicate if the brick on Tray is Blue, release it;", 36, new Color(0xFFFF00FF));
		makeLabelActor(210, 240, "else do not move Tray right", 36, new Color(0xFFFF00FF));
		...
		makeLabelActor(80, 610, "The different icons indicate", 36, new Color(0xFFFF00FF));
		makeLabelActor(100, 570, "the different color bricks", 36, new Color(0xFFFF00FF));

		makeImageActor(720, 650, 1.0f, Image.Lines.Panel.CODE_IF_ANY);
		makeLabelActor(800, 670, "Indicates any color brick", 36, new Color(0xFFFF00FF));
		makeImageActor(720, 560, 1.0f, Image.Lines.Panel.CODE_IF_NONE);
		makeLabelActor(800, 580, "Indicates NO any brick", 36, new Color(0xFFFF00FF));
		
		return true;
	}
	
	private boolean stage9() {
		makeLabelActor(340, 370, "Then, we need relase the brick on Tray", 36, new Color(0xFFFF00FF));
	...
	private boolean stage10() {
		makeLabelActor(450, 270, "Click the 'charge' icon to catch it", 36, new Color(0xFFFF00FF));
	...
	private boolean stage11() {
		makeLabelActor(440, 370, "Now, let's move Tray back left", 36, new Color(0xFFFF00FF));
	...
	private boolean stage12() {
		makeLabelActor(450, 270, "Click the 'left' icon to move it", 36, new Color(0xFFFF00FF));
	...
	private boolean stage13() {
		makeLabelActor(360, 370, "Finally, let's call the previous steps to move the Blue brick", 36, new Color(0xFFFF00FF));

...
public class LessonOne extends BaseLesson {
	...
	private boolean stage0() {
		makeLabelActor(80, 680, "Target:", 70, new Color(COLOR_TEXT));
		makeLabelActor(110, 630, "Move all bricks in the left to the same position as the right.", 40, new Color(COLOR_TEXT));
...
//		makeLabelActor(100, 465, "Code Panel used to input your operation code", 38, Color.CYAN);
		makeLabelActor(70, 420, "Click here to enter EDIT mode", 36, new Color(COLOR_TEXT));
	...
	private boolean stage1() {
		makeLabelActor(90, 405, "Click here to add your operation code", 36, new Color(COLOR_TEXT));
		makeLabelActor(155, 370, "to control Tray action", 36, new Color(COLOR_TEXT));
	...
	private boolean stage2() {
		makeLabelActor(180, 310, "The above list shows the usage of operation icons", 36, new Color(COLOR_TEXT));
		makeLabelActor(210, 270, "Now, click 'charge' operation icon", 36, new Color(COLOR_TEXT));
	...
	private boolean stage3() {
		makeLabelActor(180, 360, "Click here to add the second operation code", 36, new Color(COLOR_TEXT));
	...
	private boolean stage4() {
		makeLabelActor(130, 270, "Click the 'right' operation icon", 36, new Color(COLOR_TEXT));
	...
	private boolean stage5() {
		makeLabelActor(280, 360, "Click here to add the third operation code", 36, new Color(COLOR_TEXT));
	...
	private boolean stage6() {
		makeLabelActor(330, 260, "Click the 'charge' operation icon again", 36, new Color(COLOR_TEXT));
	...
	private boolean stage7() {
		makeLabelActor(120, 600, "Click anywhere except the current column used to input the operation code", 36, new Color(COLOR_TEXT));
	...
	private boolean stage10() {
		...
		makeLabelActor(200, 250, "Congratulate, you have passed Lesson One !", 45, new Color(COLOR_TEXT));		

...
public interface DialogConfig {
	public interface Image {
		...
		public static final String BUTTON_OK_UP = "ok_up";
		public static final String BUTTON_OK_DOWN = "ok_down";		
		...
		public interface Setting {
			...
			public static final String OPEN_UP = "setting_open_up";
			public static final String OPEN_DOWN = "setting_open_down";
			public static final String OPEN_CHECK = "setting_open_check";
			
			public static final String CLOSE_UP = "setting_close_up";
			public static final String CLOSE_DOWN = "setting_close_down";
...
//		public static final int BUTTON_BASE_X = 0;
		...
		public interface Setting {
			...
			public static final int Y_SPEED_TITLE = 555;
			
			public static final int X_SPEED_BUTTON_SLOW = X_SPEED_TITLE + 360;
			public static final int Y_SPEED_BUTTON_SLOW = Y_SPEED_TITLE - 24;
			...
			public static final int X_SPEED_BUTTON_MUSIC_OPEN = X_SPEED_TITLE + 360 + 64;
			public static final int Y_SPEED_BUTTON_MUSIC_OPEN = Y_MUSIC_TITLE - 24;
			public static final int X_SPEED_BUTTON_MUSIC_CLOSE = X_SPEED_BUTTON_MUSIC_OPEN + WIDTH_BUTTON + 2 * SPACE_BUTTON;
			...
			public static final int Y_SOUND_TITLE = 308;
